...
import CreateRealmPage from '../support/pages/manage/realms/CreateRealmPage'
import Masthead from '../support/pages/Masthead'
import adminClient from '../support/util/AdminClient'
import { keycloakBefore } from '../support/util/keycloak_hooks'
import RealmSettings from '../support/pages/manage/realms/RealmSettings'
...
describe('Realm tests', () => {
  ...
  after(() =>
    Promise.all(
      [testRealmName, newRealmName, editedRealmName].map(
