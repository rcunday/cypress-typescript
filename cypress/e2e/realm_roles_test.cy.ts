...
import createRealmRolePage from '../support/pages/manage/realms/CreateRealmRolePage'
import AssociatedRolesPage from '../support/pages/manage/realms/AssociatedRolesPage'
import { keycloakBefore } from '../support/util/keycloak_hooks'
import adminClient from '../support/util/AdminClient'
import ClientRolesTab from '../support/pages/manage/clients/ClientRolesTab'
import KeyValueInput from '../support/pages/manage/KeyValueInput'
...
describe('Realm roles test', () => {
  ...
  describe('edit role details', () => {
    ...
    it('should edit realm role details', () => {
      listingPage
        .itemExist(editRoleName)
        .goToItemDetails(editRoleName)
      createRealmRolePage
        .checkNameDisabled()
