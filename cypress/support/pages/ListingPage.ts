...
export default class ListingPage extends CommonElements {
  ...
  public tableRowItem =
    'tbody tr[data-ouia-component-type]:visible'
  private table = 'table[aria-label]'
  private filterSessionDropdownButton =
    '.pf-c-select button:nth-child(1)'
  ...
  clickRowSelectItem(
    ...
    cy.get(this.itemRowSelectItem)
      .contains(selectItemName)
      .click()
  ...
  collapseRow(index = 0) {
    this.getRowGroup(index)
      .find(
        "[class='pf-c-button pf-m-plain pf-m-expanded'][id*='expandable']",
      )
      .click()
    return this
  }
