...
export default class CommonElements {
  ...
  constructor(parentSelector = '') {
    ...
    this.primaryBtn =
      this.parentSelector + '.pf-c-button.pf-m-primary'
    this.secondaryBtn =
      this.parentSelector + '.pf-c-button.pf-m-secondary'
    this.secondaryBtnLink =
      this.parentSelector + '.pf-c-button.pf-m-link'
    this.dropdownMenuItem =
      this.parentSelector +
      '.pf-c-dropdown__menu .pf-c-dropdown__menu-item'
    this.selectMenuItem =
      this.parentSelector +
      '.pf-c-select__menu .pf-c-select__menu-item'
    this.dropdownToggleBtn =
      this.parentSelector + '.pf-c-dropdown__toggle'
    this.dropdownSelectToggleBtn =
      this.parentSelector + '.pf-c-select__toggle'
  ...
  checkIfExists(exist: boolean) {
    cy.get(this.parentSelector).should(
      (!exist ? 'not.' : '') + 'exist',
    )
    return this
  }
