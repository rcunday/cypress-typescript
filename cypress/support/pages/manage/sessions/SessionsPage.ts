export default class SessionsPage {
  ...
  setToNow() {
    ...
    cy.findByTestId(this.revocationActionItem)
      .should('exist')
      .click()
  ...
  checkNotBeforeValueExists() {
    ...
    cy.findByTestId(this.revocationActionItem)
      .should('exist')
      .click()
    cy.findByTestId(this.notBeforeInput).should(
      'not.have.value',
      'None',
    )
  }
  ...
  clearNotBefore() {
    ...
    cy.findByTestId(this.revocationActionItem)
      .should('exist')
      .click()
    cy.findByTestId(this.clearNotBeforeButton)
      .should('exist')
      .click()
  }
  ...
  logoutAllSessions() {
    ...
    cy.findByTestId(this.logoutAllConfirm)
      .should('exist')
      .click()
  }
