...
export default class RealmSettingsPage extends CommonPage {
  ...
  ssoSessionIdleSelectMenuList =
    '#kc-sso-session-idle-select-menu > div > ul'
  ssoSessionMaxSelectMenu = '#kc-sso-session-max-select-menu'
  ssoSessionMaxSelectMenuList =
    '#kc-sso-session-max-select-menu > div > ul'
  ...
  clientSessionIdleSelectMenu =
    '#kc-client-session-idle-select-menu'
  clientSessionIdleSelectMenuList =
    '#kc-client-session-idle-select-menu > div > ul'

  clientSessionMaxSelectMenu =
    '#kc-client-session-max-select-menu'
  clientSessionMaxSelectMenuList =
    '#kc-client-session-max-select-menu > div > ul'

  offlineSessionIdleSelectMenu =
    '#kc-offline-session-idle-select-menu'

  loginTimeoutSelectMenu = '#kc-login-timeout-select-menu'
  loginTimeoutSelectMenuList =
    '#kc-login-timeout-select-menu > div > ul'

  loginActionTimeoutSelectMenu =
    '#kc-login-action-timeout-select-menu'
  ...
  eventTypeColumn =
    'tbody > tr > [data-label="Event saved type"]'
  ...
  ssoSessionIdleRememberMeInput =
    'sso-session-idle-remember-me-input'
  ssoSessionMaxRememberMeInput =
    'sso-session-max-remember-me-input'
  ...
  accessTokenLifespanImplicitInput =
    'access-token-lifespan-implicit-input'
  clientLoginTimeoutInput = 'client-login-timeout-input'
  offlineSessionMaxInput = 'offline-session-max-input'
  userInitiatedActionLifespanInput =
  ...
  accessTokenLifespanSelectMenu =
    '#kc-access-token-lifespan-select-menu'
  ...
  clientLoginTimeoutSelectMenu =
    '#kc-client-login-timeout-select-menu'
  clientLoginTimeoutSelectMenuList =
    '#kc-client-login-timeout-select-menu > div > ul'

  offlineSessionMaxSelectMenu =
    '#kc-offline-session-max-select-menu'
  ...
  emailVerificationSelectMenu =
    '#kc-email-verification-select-menu'
  emailVerificationSelectMenuList =
    '#kc-email-verification-select-menu > div > ul'

  idpEmailVerificationSelectMenu =
    '#kc-idp-email-verification-select-menu'
  ...
  forgotPasswordSelectMenuList =
    '#kc-forgot-pw-select-menu > div > ul'

  executeActionsSelectMenu = '#kc-execute-actions-select-menu'
  executeActionsSelectMenuList =
    '#kc-execute-actions-select-menu > div > ul'
  ...
  private newClientProfileDescriptionInput =
  ...
  private createPolicyEmptyStateBtn =
    'no-client-policies-empty-action'
  private createPolicyBtn = 'createPolicy'
  private newClientPolicyNameInput = 'client-policy-name'
  private newClientPolicyDescriptionInput =
    'client-policy-description'
  ...
  private clientRolesConditionLink =
    'client-roles-condition-link'
  private clientScopesConditionLink =
    'client-scopes-condition-link'
  private eventListenersFormLabel = '.pf-c-form__label-text'
  private eventListenersDrpDwn =
    '.pf-c-select.kc_eventListeners_select'
  ...
  private eventListenerRemove =
    '[data-ouia-component-id="Remove"]'
  private roleSelect = 'config.roles0'
  private selectScopeButton = 'addValue'
  private deleteClientRolesConditionBtn =
    'delete-client-roles-condition'
  private deleteClientScopesConditionBtn =
    'delete-client-scopes-condition'
  ...
  disableRealm() {
    ...
    cy.findByTestId(this.modalConfirm)
      .contains('Disable')
      .click()
  }
  ...
  fillFromDisplayName(displayName: string) {
    cy.findByTestId(this.fromDisplayName)
      .clear()
      .type(displayName)
  }
  ...
  setDefaultLocale(locale: string) {
    ...
    cy.findByTestId(this.defaultLocaleList)
      .contains(locale)
      .click()
    return this
  }
  ...
  deleteProvider(name: string) {
    ...
    this.modalUtils()
      .checkModalTitle('Delete key provider?')
      .confirmModal()
  ...
  checkKeyPublic() {
    ...
    this.modalUtils()
      .checkModalTitle('Public key')
      .confirmModal()

    cy.get(this.publicKeyBtn).contains('Certificate').click()
    this.modalUtils()
      .checkModalTitle('Certificate')
      .confirmModal()
  }
  ...
  toggleSwitch(
    switchName: string,
    waitFor: boolean | undefined = true,
  ) {
  ...
  populateSessionsPage() {
    ...
    cy.findByTestId(this.ssoSessionIdleRememberMeInput)
      .clear()
      .type('3')
    this.changeTimeUnit(
      'Days',
    ...
    cy.findByTestId(this.ssoSessionMaxRememberMeInput)
      .clear()
      .type('4')
    this.changeTimeUnit(
      'Minutes',
    ...
    cy.findByTestId(this.clientSessionIdleInput)
      .clear()
      .type('5')
    this.changeTimeUnit(
      'Hours',
    ...
    cy.findByTestId(this.loginActionTimeoutInput)
      .clear()
      .type('10')
    this.changeTimeUnit(
      'Days',
  ...
  populateTokensPage() {
    ...
    cy.findByTestId(this.accessTokenLifespanImplicitInput)
      .clear()
      .type('2')
    this.changeTimeUnit(
      'Minutes',
    ...
    cy.findByTestId(this.clientLoginTimeoutInput)
      .clear()
      .type('3')
    this.changeTimeUnit(
      'Hours',
    ...
    cy.findByTestId(this.userInitiatedActionLifespanInput)
      .clear()
      .type('4')
    this.changeTimeUnit(
      'Minutes',
    ...
    cy.findByTestId(this.defaultAdminInitatedInput)
      .clear()
      .type('5')
    this.changeTimeUnit(
      'Days',
    ...
    cy.findByTestId(this.emailVerificationInput)
      .clear()
      .type('6')
    this.changeTimeUnit(
      'Days',
    ...
    cy.findByTestId(this.idpEmailVerificationInput)
      .clear()
      .type('7')
    this.changeTimeUnit(
      'Days',
  ...
  shouldDisplayEventListenersForm() {
    ...
    cy.findAllByTestId(this.eventListenersRevertBtn).should(
      'exist',
    )
  }
  ...
  shouldRemoveEventFromEventListener() {
    cy.get(this.eventListenerRemove)
      .last()
      .click({ force: true })
    cy.findByTestId(this.eventListenersSaveBtn).click({
      force: true,
  ...
  shouldReSaveEventListener() {
    cy.get(this.eventListenersInputFld)
      .click()
      .type('jboss-logging')
    cy.get(this.eventListenersDrpDwnOption).click()
    cy.get(this.eventListenersDrwDwnSelect).click()
  ...
  shouldDisplayNewClientProfileForm() {
    ...
    cy.findByTestId(
      this.newClientProfileDescriptionInput,
    ).should('exist')
  ...
  deleteClientPolicyItemFromTable(name: string) {
    ...
    this.listingPage
      .clickRowDetails(name)
      .clickDetailMenu('Delete')
    return this
  }
  ...
  shouldNavigateBetweenFormAndJSONView() {
    ...
    cy.findByTestId(this.createProfileBtn).contains(
  ...
  shouldReloadClientProfileEdits() {
    cy.get(this.clientProfileTwo).click()
    cy.findByTestId(this.newClientProfileNameInput).type(
      'Reloading',
    )
  ...
  openProfileDetails(name: string) {
    ...
    cy.get(
      'a[href*="realm-settings/client-policies/' +
        name +
        '/edit-profile"]',
    ).click()
  ...
  shouldEditExecutor() {
    cy.get(this.clientProfileTwo).click()
    cy.get(this.editExecutorBtn).click()
    cy.findByTestId(this.availablePeriodExecutorFld)
      .clear()
      .type('4000')
    cy.findByTestId(this.addExecutorSaveBtn).click()
    cy.get(this.alertMessage).should(
  ...
  shouldReloadJSONProfiles() {
    cy.findByTestId(this.jsonEditorProfilesView).check()
    cy.findByTestId(this.jsonEditorReloadBtn)
      .contains('Reload')
      .click()
    cy.findByTestId(this.jsonEditorSaveBtn).contains('Save')
    cy.findByTestId(this.jsonEditorReloadBtn).contains('Reload')
  ...
  shouldNavigateBetweenFormAndJSONViewPolicies() {
    cy.findByTestId(this.jsonEditorSelectPolicies).check()
    cy.findByTestId(this.jsonEditorSavePoliciesBtn).contains(
      'Save',
    )
    cy.findByTestId(this.jsonEditorReloadBtn).contains('Reload')
    cy.findByTestId(this.formViewSelectPolicies).check()
  ...
  checkDisplayPoliciesTab() {
    ...
    cy.findByTestId(this.jsonEditorSelectPolicies).should(
      'exist',
    )
    return this
  }
  ...
  checkNewClientPolicyForm() {
    cy.findByTestId(this.newClientPolicyNameInput).should(
      'exist',
    )
    cy.findByTestId(this.newClientPolicyDescriptionInput).should(
      'exist',
    )
    cy.findByTestId(this.saveNewClientPolicyBtn).should('exist')
    cy.findByTestId(this.cancelNewClientPolicyBtn).should(
      'exist',
    )
    return this
  }
  ...
  shouldAddClientScopesCondition() {
    ...
    cy.get('ul[class*="pf-c-data-list"]').contains(
      'client-scopes',
    )
  }
  ...
  shouldEditClientRolesCondition() {
    ...
    cy.findByTestId(this.roleSelect).should(
      'have.value',
      'manage-realm',
    )
  ...
  checkElementNotInList(name: string) {
    cy.get('tbody [data-label="Name"]').should(
      'not.contain.text',
      name,
    )
    return this
