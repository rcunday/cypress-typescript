import PageObject from '../pages/components/PageObject'
import TablePage from '../pages/components/TablePage'

export default class ModalUtils extends PageObject {
  private modalDiv = '.pf-c-modal-box'
  private modalTitle =
    '.pf-c-modal-box .pf-c-modal-box__title-text'
  ...
  private addModalDropdownItem =
    "#add-dropdown [role='menuitem']"
